...
Route::prefix('auth')->group(function () {
    ...
    Route::post('switch_update', 'Auth\LoginController@switch');
    Route::get('verify', 'Auth\LoginController@verify');
    Route::get('reset_password', 'UserController@changepassword');
    Route::get('switch_account', 'Auth\LoginController@switchaccount');
...
Route::prefix('user')->group(function () {
    ...
    Route::prefix('role')->group(function () {
     ...
     Route::prefix('business')->group(function () {
        ...
        Route::get('/get_roles', 'BusinessController@get_roles');
