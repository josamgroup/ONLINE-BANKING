...
use Modules\Limits\Entities\Limits;
...
class LimitController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data = Limits::leftJoin("clients", "clients.id", "loan_limits.customer_id")
           ...
           // ->leftJoin("users", "users.id", "wallets.created_by_id")
            ...
            ->when($search, function (Builder $query) use ($search) {
                ...
                $query->orWhere('loan_limits.id_number', 'like', "%$search%");
            })
        ...
        return theme_view('limits::limits.index', compact('data'));
    }
