            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{ trans_choice('core::general.add',1) }} {{ trans_choice('core::general.branch',1) }}</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="card-body">
                    <div class="row gy-4">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="wacc"
                                       class="control-label">Working Acc</label>
                                <input type="text" name="wacc" v-model="wacc"
                                       id="wacc"
                                       class="form-control @error('wacc') is-invalid @enderror" required>
                                @error('wacc')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                      ...
                      <!--   <div class="col-md-4">
                            <div class="form-group">
                                <label for="weq"
                                       class="control-label">Working Equity</label>
                                <input type="text" name="weq" v-model="weq"
                                       id="weq"
                                       class="form-control @error('weq') is-invalid @enderror" required>
                                @error('weq')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                         ...
                         <div class="col-md-6">
                            <div class="form-group">
                                <label for="utility_acc"
                                       class="control-label">Utility Acc</label>
                                <input type="text" name="utility_acc" v-model="utility_acc"
                                       id="utility_acc"
                                       class="form-control @error('utility_acc') is-invalid @enderror" required>
                                @error('utility_acc')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
