    ...
    function get_menu()
    {
        $this->menu->dropdown(trans_choice('loan::general.loan', 2), function ($sub) {
            ...
            $sub->url('loan/product', trans_choice('core::general.manage', 1) . ' ' . trans_choice('loan::general.loan', 1) . ' ' . trans_choice('loan::general.product', 2), ['icon' => 'fa fa-circle-o']);
             $sub->url('loan/rates', trans_choice('loan::general.loan', 1) . ' ' . 'Loan Rates', ['icon' => 'fa fa-circle-o']);

              $sub->url('loan/limits', trans_choice('loan::general.loan', 1) . ' ' . 'Client Limits', ['icon' => 'fa fa-circle-o']);
            ...
            $sub->url('loan/wallets', trans_choice('core::general.manage', 1) . ' ' . trans_choice('loan::general.loan', 1) . ' ' . 'Client Wallets', ['icon' => 'fa fa-circle-o']);
