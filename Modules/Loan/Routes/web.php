...
Route::prefix('loan')->group(function () {
    ...
    Route::get('arreas', 'LoanController@arreas');
    ...
    Route::post('{id}/close_loan', 'LoanController@closed_loan');
...
//applications
    ...
    Route::get('{id}/guarantor/create', 'LoanGuarantorController@create');
     Route::post('guarantor/{id}/approve', 'LoanGuarantorController@approve_guarantor');
    ...
    Route::prefix('rates')->group(function () {
        Route::get('/', 'LoanRatesController@index');
        Route::get('get_charges', 'LoanRatesController@get_charges');
        Route::get('get_charge_types', 'LoanRatesController@get_charge_types');
        Route::get('get_charge_options', 'LoanRatesController@get_charge_options');
        Route::get('create', 'LoanRatesController@create');
        Route::post('store', 'LoanRatesController@store');
        Route::get('{id}/show', 'LoanRatesController@show');
        Route::get('{id}/edit', 'LoanRatesController@edit');
        Route::post('{id}/update', 'LoanRatesController@update');
        Route::get('{id}/destroy', 'LoanRatesController@destroy');
    });
       //rates
    Route::prefix('wallets')->group(function () {
        Route::get('/', 'LoanWalletsController@index');
        Route::get('get_charges', 'LoanWalletsController@wallets');
        Route::get('create', 'LoanWalletsController@create');
        Route::post('store', 'LoanWalletsController@store');
        Route::get('{id}/show', 'LoanWalletsController@show');
        Route::get('{id}/edit', 'LoanWalletsController@edit');
        Route::post('{id}/update', 'LoanWalletsController@update');
        Route::get('{id}/destroy', 'LoanWalletsController@destroy');
    });
     Route::prefix('limits')->group(function () {
        Route::get('/', 'LimitController@index');
        Route::get('get_charges', 'LimitController@wallets');
        // Route::get('get_charge_types', 'LoanRatesController@get_charge_types');
        // Route::get('get_charge_options', 'LoanRatesController@get_charge_options');
        // Route::get('create', 'LoanRatesController@create');
        // Route::post('store', 'LoanRatesController@store');
        Route::get('{id}/show', 'LimitController@show');
        Route::get('{id}/edit', 'LimitController@edit');
        Route::post('{id}/update', 'LimitController@update');
        Route::get('{id}/destroy', 'LimitController@destroy');
    });
    //loan product
...
Route::prefix('report')->group(function () {
    ...
    Route::get('loan/mpesa_transactions', 'ReportController@mpesa_transactions');
