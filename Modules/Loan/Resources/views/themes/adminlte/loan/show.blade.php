            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{ trans_choice('loan::general.loan',1) }} {{ trans_choice('core::general.detail',2) }}</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                                            ...
                                            <div class="modal fade" id="withdraw_loan_modal">
                                             ...
                                             <div class="modal fade" id="approve">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title">Approve Guarantor</h4>
                                                            <button type="button" class="close" data-dismiss="modal"
                                                                    aria-label="Close">
                                                                <span aria-hidden="true">×</span></button>
                                                        </div>
                                                        <form method="post"
                                                              action="{{ url('loan/guarantor/'.$loan->id.'/approve') }}">
                                                            {{csrf_field()}}
                                                            <div class="modal-body">
                                                                <div class="form-group">
                                                                    <label for="otp"
                                                                           class="control-label">Enter Otp</label>
                                        ...
                                        @endcan
                                         @can('loan.loans.write_off_loan')
                                            <a href="#" data-toggle="modal" data-target="#close_loan_modal"
                                               class="btn btn-primary">
                                                Close {{ trans_choice('loan::general.loan',1) }}
                                            </a>
                                        @endcan
                                          ...
                                          @can('loan.loans.write_off_loan')
                                            <div class="modal fade" id="close_loan_modal">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title">Close {{ trans_choice('loan::general.loan',1) }}</h4>
                                                            <button type="button" class="close" data-dismiss="modal"
                                                                    aria-label="Close">
                                                                <span aria-hidden="true">×</span></button>
                                                        </div>
                                                        <form method="post"
                                                              action="{{ url('loan/'.$loan->id.'/close_loan') }}">
                                                            {{csrf_field()}}
                                                            <div class="modal-body">
                                                                <div class="form-group">
                            ...
                            <div class="col-sm-4 col-md-4">
                                <table class="table table-striped table-bordered ">
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                        <th class="table-bold-loan">{{ trans_choice('loan::general.service_fee',1) }}</th>
                                        <td>
                                            {{number_format($loan->fee,$loan->decimals)}}
                                        </td>
                                    </tr>
                                                ...
                                                <td>
                                                    ...
                                                    @can('loan.loans.collateral.destroy')
                                                        <a href="{{url('loan/collateral/'.$key->id.'/destroy')}}"
                                                           class="confirm"><em class="fas fa-trash"></em> </a>
                                                    @endcan
                                                </td>
                                            </tr>
                                        @endforeach
                                ...
                                <div class="tab-pane" id="loan_guarantors">
                                    ...
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        @foreach($loan->guarantors as $key)
                                            ...
                                            <a href="#" data-toggle="modal" data-target="#approve" data-id="{{$key->loan_id}}" onclick="$('#dataid').val($(this).data('id'));
                                                   ...
                                                   <!--  <a  href="#" data-toggle="modal" data-target="#withdraw_loan_modal"   ><i class="fas fa-check"></a> -->
                                                        <!-- data-id="{{$key->id}}" onclick="$('#dataid').text($(this).data('id')); $('#showmodal').modal('show');" -->
                                                    @endcan
                                                </td>
                                            </tr>
                                        @endforeach
