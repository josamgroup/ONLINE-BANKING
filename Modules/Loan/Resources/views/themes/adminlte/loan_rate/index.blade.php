...
@section('title')
    {{ trans_choice('loan::general.rates',1) }}  {{ trans_choice('loan::general.rates',2) }}
@endsection
@section('styles')
@stop
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{ trans_choice('loan::general.rates',1) }}  {{ trans_choice('loan::general.rates',2) }}</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{ trans_choice('loan::general.rates',1) }}  {{ trans_choice('loan::general.rates',2) }}</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <form class="form-inline ml-0 ml-md-3" action="{{url('loan/rates')}}">
                    ...
                    @foreach($data as $key)
                        <tr>
                             <td>
                                ...
                                <span>{{$key->rate_id}} </span>
                             
                            </td>
                            <td>
                             
                                <span>{{number_format($key->lower, 2)}} </span>
                             
                            </td>
                            <td>
                              
                            <span>{{number_format($key->upper, 2)}} </span>
                             
                            </td>
                              <td>
                             <span>{{number_format($key->rate, 2)}} </span>
                            </td>
                                ...
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        @can('loan.loans.charges.edit')
                                            ...
                                            <a href="{{url('loan/rates/' . $key->id . '/edit')}}" class="dropdown-item">
                                        ...
                                        @can('loan.loans.charges.destroy')
                                            ...
                                            <a href="{{url('loan/rates/' . $key->id . '/destroy')}}"
