        ...
        <div class="card">
            <div class="card-body p-0">
                <table id="" class="table table-striped table-hover">
                    ...
                    <tr>
                        <td>
                            <a href="{{url('report/loan/mpesa_transactions')}}">Mpesa Transactions</a>
                        </td>
                        <td>
                            List of all Mpesa transactions or payment over a period of time.
                        </td>
                        <td><a href="{{url('report/loan/mpesa_transactions')}}"><i
                                        class="fa fa-search"></i> </a>
                        </td>
                    </tr>
                    <tr>
