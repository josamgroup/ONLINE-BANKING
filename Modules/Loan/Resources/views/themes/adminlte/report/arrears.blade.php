                    ...
                    <div class="dropdown">
                        <a href="#" class="btn btn-info btn-trigger btn-icon dropdown-toggle"
                          ...
                          <div class="dropdown-menu dropdown-menu-xs dropdown-menu-right">
                            <a href="{{url('report/loan/arrears?download=1&type=csv&start_date='.$start_date.'&end_date='.$end_date.'&branch_id='.$branch_id.'&loan_product_id='.$loan_product_id.'&loan_officer_id='.$loan_officer_id.'&other=')}}" class="dropdown-item">{{trans_choice('core::general.download',1)}} {{trans_choice('core::general.csv_format',1)}}</a>
                            <a href="{{url('report/loan/arrears?download=1&type=excel&start_date='.$start_date.'&end_date='.$end_date.'&branch_id='.$branch_id.'&loan_product_id='.$loan_product_id.'&loan_officer_id='.$loan_officer_id.'&other=')}}" class="dropdown-item">{{trans_choice('core::general.download',1)}} {{trans_choice('core::general.excel_format',1)}}</a>
                            <a href="{{url('report/loan/arrears?download=1&type=excel_2007&start_date='.$start_date.'&end_date='.$end_date.'&branch_id='.$branch_id.'&loan_product_id='.$loan_product_id.'&loan_officer_id ='.$loan_officer_id.'&other=')}}" class="dropdown-item">{{trans_choice('core::general.download',1)}} {{trans_choice('core::general.excel_2007_format',1)}}</a>
                            <a href="{{url('report/loan/arrears?download=1&type=pdf&start_date='.$start_date.'&end_date='.$end_date.'&branch_id='.$branch_id.'&loan_product_id='.$loan_product_id.'&loan_officer_id='.$loan_officer_id.'&other=')}}" class="dropdown-item">{{trans_choice('core::general.download',1)}} {{trans_choice('core::general.pdf_format',1)}}</a>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="loan_officer_id" id="loan_officer_id">
                                    ...
                                    @foreach($users as $key)
                                        <option value="{{$key->id}}"
                                                @if($loan_officer_id==$key->id) selected @endif>{{$key->id}} {{$key->first_name}} {{$key->last_name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <tr>
                                ...
                                <td bgcolor="black" style="color:red;">
                                    @if($key->last_payment_date)
                                        ...
                                        @else
                                        <b style="color:red;">No payment(s)</b>
                                    @endif
                                </td>
                            </tr>
                        @endforeach
