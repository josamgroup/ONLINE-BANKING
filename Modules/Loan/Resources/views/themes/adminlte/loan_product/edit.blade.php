                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                                <label for="guarantor"
                                       class="control-label">Requires Guarantor</label>
                                <select class="form-control  @error('guarantor') is-invalid @enderror" name="guarantor"
                                        id="guarantor" v-model="guarantor"
                                        required>
                                    <option value=""></option>
                                    <option value="0">{{trans_choice('core::general.no',1)}}</option>
                                    <option value="1" selected>{{trans_choice('core::general.yes',1)}}</option>
    ...
    <script>
        var app = new Vue({
            ...
            data: {
                ...
                selected_credit_checks: {!! json_encode($selected_credit_checks) !!},
                ...
                guarantor: "{{old('guarantor',$loan_product->guarantor)}}",
