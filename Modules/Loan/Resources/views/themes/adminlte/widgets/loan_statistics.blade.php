        ...
        <div class="row">
            <div class="col-md-3">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text"><a href="report/loan/disbursement">   {{ trans_choice('loan::general.loan',2) }} {{ trans_choice('loan::general.disbursed',2) }}</a></span>
            ...
            <div class="col-md-3">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text"><a href="report/loan/repayment">   {{ trans_choice('loan::general.total',1) }} {{ trans_choice('loan::general.repayment',2) }} </a></span>
            ...
            <div class="col-md-3">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text"><a href="report/loan/collection_sheet">    {{ trans_choice('loan::general.total',1) }} {{ trans_choice('loan::general.outstanding',2) }}</a></span>
            ...
            <div class="col-md-3">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text"><a href="report/loan/arrears">   {{ trans_choice('loan::general.total',1) }} {{ trans_choice('loan::general.arrears',2) }}</a></span>
