    ...
    <div class="row">
            ...
            <div class="info-box">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">
                        {{number_format(\Modules\Loan\Entities\LoanWallets::where('AccountID',session('client_id'))->sum('balance'))}}</span>
                </div>
                <!-- /.info-box-content -->
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="info-box">
                <span class="info-box-icon bg-aqua"><i class="fa fa-money"></i></span>
                <div class="info-box-content">
                    <span class="info-box-text">{{ trans_choice('loan::general.total',1) }} {{ trans_choice('loan::general.loan',2) }} 3e</span>
